...
<div style="margin-left:35%;padding:1px 16px;height:1000px;">
  ...
  <div id="wrapper">
		<div id="header">
		<h1>Add and Remove Department</h1>
		</div>
	</div>
	...
	<div id="container">
		...
		<table>
				...
				<c:forEach var="tempDepart" items="${departments}">
				
					<tr>
						<td> ${tempDepart.department} </td>
						<c:url var="Edit" value="/department/edit">
						     <c:param name="id" value="${tempDepart.id}" />
			...
			<button type="button" ><a href="/department/add">Add Department</a></button>
		</div>
